...
class JwtServiceClass {
  ...
  getSecretKey(type: "access" | "refresh") {
    return type === "access"
      ? jwtConfig.configs.access_token_secret_key
      : jwtConfig.configs.refresh_token_secret_key;
  }

  getExpireTime(type: "access" | "refresh") {
    return type === "access"
      ? jwtConfig.configs.access_token_expiration_time
      : jwtConfig.configs.refresh_token_expiration_time;
  }
